...
Source0  : https://github.com/tukaani-project/xz/releases/download/v5.4.6/xz-5.4.6.tar.xz
Source1  : https://github.com/tukaani-project/xz/releases/download/v5.4.6/xz-5.4.6.tar.xz.sig
...
%prep
%setup -q -n xz-5.4.6
cd %{_builddir}/xz-5.4.6
%patch -P 1 -p1
%patch -P 2 -p1
%patch -P 3 -p1
%patch -P 4 -p2
pushd ..
cp -a xz-5.4.6 build32
popd
pushd ..
cp -a xz-5.4.6 buildavx2
popd
pushd ..
cp -a xz-5.4.6 buildavx512
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1706290450
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/liblzma.so.5.4.6
/V4/usr/lib64/liblzma.so.5.4.6
/usr/lib64/liblzma.so.5
/usr/lib64/liblzma.so.5.4.6

%files lib32
%defattr(-,root,root,-)
/usr/lib32/liblzma.so.5
/usr/lib32/liblzma.so.5.4.6
