...
Source0  : https://tukaani.org/xz/xz-5.4.5.tar.xz
Source1  : https://tukaani.org/xz/xz-5.4.5.tar.xz.sig
...
%prep
%setup -q -n xz-5.4.5
cd %{_builddir}/xz-5.4.5
%patch -P 1 -p1
%patch -P 2 -p1
%patch -P 3 -p1
%patch -P 4 -p2
pushd ..
cp -a xz-5.4.5 build32
popd
pushd ..
cp -a xz-5.4.5 buildavx2
popd
pushd ..
cp -a xz-5.4.5 buildavx512
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1698857585
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/liblzma.so.5.4.5
/V4/usr/lib64/liblzma.so.5.4.5
